...
// -----------------------------------------------------------------------
// GET /api/admin/bookings?scope=today|all&service=<name>
//
...
// for a later phase.
//
// `service` (optional) additionally filters to one service_type — this is
// what the admin Services tab's cards link to, so clicking "Tyres" jumps
// straight to just the tyre jobs instead of the full list.
// -----------------------------------------------------------------------
