          ...
          <div className="mx-auto max-w-3xl px-5 py-6">
            ...
            {service && (
              <button
                ...
                className="mb-5 inline-flex items-center gap-1.5 bg-amber-100 text-amber-900 text-sm font-semibold pl-3 pr-2 py-1.5 rounded-full hover:bg-amber-200 transition"
              >
                Filtered: {service}
